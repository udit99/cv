...
\section {\ \ \ \ \ \ Technical Architect at Healthagen\textnormal{\ \ \ \ \ \ \ \ \ \  \  \ \ \ \ \ \ \  \ \ \ \ \  \ \ \ \\ \ \ \ \ \ \ \ (Sep 2013-Present)}}\vspace{0.01in}
   \begin{tabbing}
   \hspace{3.3in}\= \kill % set up two tab positions
Involvecare - www.involvecare.com\>iOS/Ruby on Rails \\
\end{tabbing}
\vspace{-0.3in}
\section {\ \ \ \ \ \ Developer/Consultant at ThoughtWorks \textnormal{\ \ \ \ \ \ \ \ \ \ \ \  \ \ \ \ \ \ \ \ \ \ \ \ (2007-Sep 2013)}}\vspace{-0.06in}
   \begin{tabbing}
   \hspace{3.3in}\= \kill % set up two tab positions
