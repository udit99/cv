...
\address{San Francisco \\ (515) 770-2500}
\address{udit@manektala.com \\ udit.manektala.com}
                                  
\begin{resume}
 \moveleft\hoffset\vbox{\hrule width\resumewidth height 1pt}\smallskip
\section{WORK HISTORY}       
\section {\ \ \ \ \ \ Technical Architect at Healthagen\textnormal{\ \ \ \ \ \ \ \ \ \  \  \ \ \ \ \ \ \  \ \ \ \ \  \ \ \ \\ \ \ \ \ \ \ \ (Sep 2013-Present)}}\vspace{0.05in}
   \begin{tabbing}
   \hspace{3.3in}\= \kill % set up two tab positions
Involvecare - www.involvecare.com\>iOS/Ruby on Rails \\
\end{tabbing}


\section {\ \ \ \ \ \ Developer/Consultant at ThoughtWorks \textnormal{\ \ \ \ \ \ \ \ \ \ \ \  \ \ \ \ \ \ \ \ \ \ \ \ (2007-Sep 2013)}}\vspace{-0.01in}
   \begin{tabbing}
   \hspace{3.3in}\= \kill % set up two tab positions

Google \>Internal Google Tech\\

Nook Media - uk.nook.com \>Ruby on Rails \\
